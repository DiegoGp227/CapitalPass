const Nav = () => {
  return (
    <nav className="mx-20 flex justify-end items-center ">
      <button className="p-2 bg-green-500 text-white rounded-2xl hover:bg-green-600 cursor-pointer shadow-lg">
        Generar codigo de pago
      </button>
      <section className="mx-40 cursor-pointer">
        <svg
